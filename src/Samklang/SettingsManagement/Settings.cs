...
/// a single flat record so the file is read/written atomically; later issues (device targeting,
/// tier mappings, autostart) are expected to add more properties here rather than introduce
/// separate files.
/// </summary>
public sealed record Settings(DeviceFormat RestingFormat, TimeSpan GracePeriod, string? StorefrontOverride = null)
{
